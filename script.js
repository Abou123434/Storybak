...
function renderStories(){
    ...
    Object.keys(users).forEach(u=>{
        ...
        div.appendChild(img); div.appendChild(plus);
...
// RETRAIT → KYC
withdrawBtn.onclick=()=>{ kycModal.style.display="flex"; kycStatus.innerHTML=""; kycPaypalBtn.style.display="none"; };
