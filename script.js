...
function showStory(){
    ...
    e.src = s.url; if(s.type==="video") e.autoplay = true;
    c.appendChild(e);
...
function closeViewer(){ clearInterval(timer); document.getElementById("viewer").style.display="none"; hideViewerButtons(); }
...
function renderControls(){
    ...
    let giftBtn = document.createElement("button"); giftBtn.innerText="🎁 Envoyer un cadeau";
    giftBtn.onclick = openGiftModal; controls.appendChild(giftBtn);
...
function showViewerButtons(){ bosteBtn.style.display="block"; publishBtn.style.display="block"; body.classList.add("viewer-open"); }
function hideViewerButtons(){ bosteBtn.style.display="none"; publishBtn.style.display="none"; body.classList.remove("viewer-open"); }

bosteBtn.onclick = ()=>{ alert("Boste cliqué !"); hideViewerButtons(); }
publishBtn.onclick = ()=>{ alert("Publier la story !"); hideViewerButtons(); }
