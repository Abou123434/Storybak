...
"👁 "+Object.keys(story.views).length+" vues";
...
<h3>Choisir quantité ${selectedGiftEmoji}</h3>
...
document.getElementById("closeBuyCoinsModal").onclick=()=>{
...
document.getElementById("mobileMoneyModal").style.display="flex";
