...
document.querySelectorAll("#buyCoinsModal li").forEach(li=>{ li.onclick=()=>{ document.getElementById("buyCoinsModal").style.display="none"; document.getElementById("paymentModal").style.display="flex"; }; });
document.getElementById("paypalBtn").onclick=()=>{ window.open("about:blank","_blank"); };
...
walletBtn.onclick=()=>{
    ...
    walletDiamonds.innerText=8400;
    walletValue.innerText=84;
